...
build_id_locate_exec (int from_tty)
{
  ...
  gdb::unique_xmalloc_ptr<char> execfilename, build_id_filename_ptr;
  ...
  execfilename.reset(build_id_to_filename (build_id.get(), &build_id_filename));
  build_id_filename_ptr.reset(build_id_filename);
