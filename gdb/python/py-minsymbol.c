...
msympy_get_type (PyObject *self, void *closure)
{
  ...
  MSYMPY_REQUIRE_VALID (self, minsym);
  return PyLong_FromLong(MSYMBOL_TYPE(minsym));
}
...
minsym_type(struct minimal_symbol *minsym)
{
  ...
  case mst_slot_got_plt:
    type = builtin_type (gdbpy_enter::get_gdbarch ())->builtin_func_ptr;
    break;
  ...
  case mst_file_data:
  case mst_file_bss:
    type = builtin_type (gdbpy_enter::get_gdbarch ())->builtin_data_ptr;
    break;

  case mst_unknown:
  default:
    type = builtin_type (gdbpy_enter::get_gdbarch ())->builtin_void;
    break;
  }
...
{
  struct minimal_symbol *minsym = NULL;
  struct type *type = builtin_type (gdbpy_enter::get_gdbarch ())->builtin_func_ptr;
  MSYMPY_REQUIRE_VALID (self, minsym);
...
{
  struct minimal_symbol *minsym = NULL;
  struct type *type = builtin_type (gdbpy_enter::get_gdbarch ())->builtin_data_ptr;
  MSYMPY_REQUIRE_VALID (self, minsym);
